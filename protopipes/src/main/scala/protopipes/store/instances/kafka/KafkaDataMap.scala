...
import protopipes.connectors.instances.IgnoreKeyAdaptor
import protopipes.data.Identifiable
import protopipes.data.serializers.BasicSerializer
import protopipes.exceptions.{CallNotAllowException, NotInitializedException}
import protopipes.store.{DataMap, DataQueue, DataStream, DropLeftDataStreamAdaptor}
import protopipes.store.instances.{InMemDataMap, InMemDataQueue}
